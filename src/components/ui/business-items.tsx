...
export const BusinessItems = ({business, onSelect, isChecked} : BusinessItemsProps) => {
    return(
        <div className="flex items-center px-2 py-1 cursor-pointer hover:bg-gray-50 text-muted-background hover:text-color-primary" onClick={() => onSelect(business)}>
